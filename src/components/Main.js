...
function Main() {
  return (
    <div className="main-style">
      ...
      <div className="product-style" >Products</div>
      
      <div className="product-style" style={{ marginLeft: "40px" }}>
        Resources
      </div>

      <div className="input-style">
        <div
          className="inputin inputin1"
          style={{ marginTop: "77px", marginLeft: "600px", height: "30px",width: "300px"
           }}
        >
          <svg
            width="13"
          ...
          <div style={{ marginLeft: "-56px", marginTop: "-18px" }}>
            {" "}
            Claim,edit,renew & more
          </div>
        </div>
        <div className="Login-style" style={{ width: "91px", height: "31px" }}>
          login{" "}
        </div>
      
      </div>
      <div className="help-style"> Help</div>
    </div>
  );
}
